...
with mantik.engine.Client("localhost", 8087) as client:
    simple_learn = client._add_algorithm("../../bridge/sklearn/production", named_mantik_id = "mantik/sklearn.simple")
    kmeans = client._add_algorithm("../../bridge/sklearn/production/example/gradientboosting")
