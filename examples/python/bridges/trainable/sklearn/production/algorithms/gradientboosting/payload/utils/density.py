...
def calculate_air_density(
    ...
    pressure = calculate_pressure(
        ...
        constants=constants.to_dataframe(),
...
def _magnus(theta: float, c0: float, c1: float, c2: float) -> float:
...
def _r_f(theta: float, p: float, rh: float) -> float:
